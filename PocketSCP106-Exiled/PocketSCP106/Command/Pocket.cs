        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response)
        {
            ...
            if (!player.IsInPocketDimension)
            {
                Timing.CallDelayed(0.5f, () => {
                    /*if (Plugin.plugin.Config.AnimTeleportStart)
                    {
                        ...
                        player.ReferenceHub.scp106PlayerScript.SetPortalPosition(new Vector3(0.2f, -2000.67f, -0.05f), new Vector3(0.2f, -2000.67f, -0.05f));
                        ...
                        Log.Debug(player.ReferenceHub.scp106PlayerScript.portalPosition);
                        ...
                        //Timing.CallDelayed(4f, () => Plugin.plugin.handlers.isgod = true);
            ...
            else
            {
                ...
                Timing.CallDelayed(0.5f, () =>
                {
                    ...
                    {
                        player.ReferenceHub.scp106PlayerScript.SetPortalPosition(new Vector3(Pos.x, Pos.y - 2f, Pos.z), new Vector3(Pos.x, Pos.y - 2f, Pos.z));
